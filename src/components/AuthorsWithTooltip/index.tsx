...
export const AuthorsWithTooltip = ({
  items,
}: {
  items: {
    name: string;
      ...
      {items.map((item, idx) => (
        ...
        >
          ...
          {item.image_url ? (
            ...
            <div className="w-12 h-12 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-full border-2 group-hover:scale-105 group-hover:z-30 border-white relative transition duration-500" />
          )}
        </div>
      ))}
    </>
