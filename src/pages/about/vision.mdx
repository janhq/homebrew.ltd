---
title: Vision 
description: We see a future where humanity can focus on what truly matters - after drinking homebrew coffees. ☕
keywords:
  [
    Homebrew,
    Thinking Machines,
...
**Our vision is simple**: Building AI that makes us better – as thinkers, as tinkerers, as human beings.
...
In this AI leap, we are the tool makers forging the tools that will create the things we couldn't imagine today, and help our children solve tomorrow's problems.
...
- AI that enhances us and that we can tinker to
- AI that augments us by collaborating with us
...
One of humanity's most astonishing capabilities is our ability to perform incredibly complex and creative tasks without the need for massive power sources. The human brain is capable of doing extraordinary feats of cognition while consuming minimal energy, however, current AIs require enormous amounts of energy and generate significant heat. This is also a call to action for a problem that we need to solve to do more. That's why we are working on AI that runs earth-friendly on energy-efficient hardware.

We believe that earth-friendly AI preserves our world for future generations. 
It's setting the stage for a civilization that can expand beyond Earth.

At Homebrew, we tinker and build AI to push the human race forward.
