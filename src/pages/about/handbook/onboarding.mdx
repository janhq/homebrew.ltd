---
title: Culture
description: At Homebrew, each team member embraces the vision of building human-augmented AI that can run on energy-efficient hardware.
keywords:
  [
    Homebrew,
    Thinking Machines,
...
At Homebrew, each team member embraces [the vision](https://homebrew.ltd/about/vision) of building human-augmented AI that can run on energy-efficient hardware. We expect each team member to be a great teammate, which requires a few expectations:
...
If conflicts do arise, first assume [Hanlon’s Razor](https://en.wikipedia.org/wiki/Hanlon%27s_razor): "Never attribute to malice that which is adequately explained by stupidity lack of communication or too much ambiguity". Don’t take things personally, be a professional.
