---
title: Llama learns to listen (sort of)
...
# Llama learns to listen (sort of)

We’re excited to share [llama3s v0.2](https://huggingface.co/homebrewltd/Llama3.1-s-instruct-2024-08-19-epoch-3), our latest multimodal checkpoint with improved speech understanding.

## Demo

<iframe
    className="w-full aspect-video"
    src={`https://www.youtube.com/embed/QMRIaWIC5AA`}
    title="YouTube Video"
    frameBorder="0"
    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
></iframe>
*[HF demo](https://huggingface.co/spaces/jan-hq/Llama3.1-s-v0.2-checkpoint-2024-08-20) (20th Aug 2024): the model listens to human instructions and responds in text.*

**Llama3s v0.2 consistently performs across multiple `Speech Understanding` benchmarks** (see [Results](#results)). While more analysis is needed, we’re excited to share this progress with the community and get feedback. 

**You can try the [demo here](https://huggingface.co/spaces/jan-hq/Llama3.1-s-v0.2-checkpoint-2024-08-20) or [build it from scratch](https://github.com/homebrewltd/llama3-s)**. For this round, please ask questions in English and keep them under 10 seconds long. This is due to our model's limitation in being trained on audio prompts with fewer than 500 tokens, which we plan to address in a future update.
...
**Data**: We used the [MLS-10k dataset](https://huggingface.co/datasets/parler-tts/mls_eng_10k) (10 hours of unlabeled, multilingual human speech courtesy of OpenSLR) to pre-train llama3.1 8b on next token prediction. 
...
Our training dataset didn’t contain Alpaca Instruction. At epoch 3, **llama3s v.02 achieved an average score of 3.53 on the ALPACA-Audio eval**, which seems to beat SALMONN, Qwen-Audio and WavLLM.
...
We want to evolve llama3s into a functional, multi-turn speech model, that is good at low resource languages. As most of our team is based in the SEAsia region, we are passionate about getting better generalization across the many accents and dialects spoken here. Long term, this requires a large and long term data effort.
...
- Contributors: [yipjiaqi](https://www.linkedin.com/in/yip-jia-qi), 
---
