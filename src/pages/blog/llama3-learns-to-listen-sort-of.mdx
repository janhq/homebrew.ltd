...
**Long term, we aim to develop an open, multi-turn speech model for llama3s that excels in low-resource languages, with a focus on improving generalization across ASEAN's diverse accents and dialects.** Achieving this will necessitate a significant and sustained data collection effort.
