...
Our identity is filled with values rented from others.

In fact, we are renting. Our views, our likes, our loves, and even our character that changes with them. We adopt things that are monopolized by others as if they were our own.
The only thing we can access them through are those small devices we rent. Because there will never be an iPhone higher than the latest version of the iPhone, and this is where we become equal.
...
We no longer have, we live in the illusion that we own the things we rent.
