...
categories: research
ogImage: /_assets/llama3s/llama-book.png)
date: 2024-08-06
---
...
We invite you to join llama3-s: an open and ongoing research experiment focused on teaching llama3 to listen. This blog post is a quick project update and also an open call to join to us to build a speech adapter on top of llama3.
