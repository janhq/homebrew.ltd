...
We want to invite you to join [llama3-s](https://github.com/homebrewltd/llama3-s): an open and ongoing research experiment focused on teaching llama3 to listen. It's an open invitation to join llama3-s!
