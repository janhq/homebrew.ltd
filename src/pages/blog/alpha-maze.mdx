...
Alpha Maze takes a different approach. We built our model on a distilled, [7-billion parameter Qwen model](https://huggingface.co/deepseek-ai/DeepSeek-R1-Distill-Qwen-7B) (based on Deepseek-R1), and trained it to solve mazes presented in a text-based format. Our core hypothesis is that if a model can successfully reconstruct a maze from a text description and use that internal representation to plan its next move, it demonstrates a form of visual reasoning.

![GPT-4o and Qwen failed on solving a maze](./_assets/alphamaze/gpt-qwen.jpg)

*[GPT-4o](https://chatgpt.com/c/67ac8a3a-d9f4-8008-b76d-3edd7afb3308) and [Qwen-Max](https://chat.qwenlm.ai/s/e4b3ba51-2902-4ae6-95df-fbf2d0f2145c) failed on solving a maze.*

> Golden label: `<|up|> <|left|> <|left|> <|left|> <|up|> <|up|>`
...
Training data: 75,000 samples (filter out samples have over 4096 tokens).
...
| :----- |  :------------ | :--------- | :---- | :------ | :----------------------- | :--------------------------------------------------------------------------------------------------------------------- |
| exp-1  |  [Full-Finetune](https://github.com/janhq/visual-thinker/blob/main/training/Llama-factory-config/Qwen2.5_1.5B_distil.yaml) | [Maze Reasoning](https://huggingface.co/datasets/jan-hq/Maze-Reasoning)   |  | 0.01    | ~1.5 hours on 6xA6000s | Added new maze tokens |
| exp-2  |  [Full-Finetune](https://github.com/janhq/visual-thinker/blob/main/training/Llama-factory-config/Qwen2.5_1.5B_distil.yaml) | [Maze Reasoning](https://huggingface.co/datasets/jan-hq/Maze-Reasoning)  |    | 0.01    | ~1.5 hours on 6xA6000s |  Pure text |
| exp-3  |  [Full-Finetune](https://github.com/janhq/visual-thinker/blob/main/training/Llama-factory-config/Qwen2.5_7B_distil.yaml)  | [Maze Reasoning](https://huggingface.co/datasets/jan-hq/Maze-Reasoning) |      | 0.0077  | ~12 hours on 6xA6000s  | Expanded pure text training |
