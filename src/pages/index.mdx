...
We're a bunch of AI hobbyists tinkering with local AI. We're researching local AI, building tools, and contributing to open-source projects.
...
All our projects are built in public - we even train Ichigo in public.

We have hardware dreams in the making:
...
We've got tons of lessons on:

- Creating custom local AI models
- Training a speech model
- Hardware edge cases for local AI
- Building AI apps

Intrigued? If you're thinking of business, give us a shout.
